...
print("Jackknife\t=%d" % int(support.estimate_jackknife1(fin)))
print("Turing-Good\t=%d" % int(support.estimate_turing_good(fin)))
print("Chao1\t\t=%d" % int(support.estimate_chao1(fin)))
print("Chao-Lee1\t=%d" % int(support.estimate_chao_lee1(fin)))
print("Chao-Lee2\t=%d" % int(support.estimate_chao_lee2(fin)))
print("")
